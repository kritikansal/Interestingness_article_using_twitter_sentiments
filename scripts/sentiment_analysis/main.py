...
def getStopWords():
	f=open("/home/kriti/Downloads/Articulate/scripts/sentiment_analysis/finalstoplist","r")
	global stop_list
...
def getPositiveWords():
	f=open("/home/kriti/Downloads/Articulate/scripts/sentiment_analysis/positive.txt","r")
	global positive_list
...
def getNegativeWords():
	f=open("/home/kriti/Downloads/Articulate/scripts/sentiment_analysis/negative.txt","r")
	global negative_list
...
getPositiveWords()	
getNegativeWords()
folderPath="/home/kriti/Downloads/Articulate/files/articles/"
fileNames = []
articles = []
...
for entity_list in articles:
	it+=1
	ent={}
	with open('/home/kriti/Downloads/Articulate/files/x','r') as f:
	    for line in f:
